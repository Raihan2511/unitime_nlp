...
test_processed = preprocess_data(test_offerings, test_reservations, test_preferences)
...
print(f"✅ Saved {len(train_processed_data)} training and {len(processed_val)} and {len(test_processed)} test samples to JSON files.")
...
evaluate_model(".model/checkpoints", "data/processed/test_data.json")
